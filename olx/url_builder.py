...
class URLBuilder:
    ...
    def build_url(self, page: int = 1) -> str:
        ...
        if page > 1:
            url = f"https://www.olx.uz/{city}/q-{item_query}/?page={page}&{distance_string}search%5Border%5D=created_at:desc"
        else:
            url = f"https://www.olx.uz/{city}/q-{item_query}/?{distance_string}search%5Border%5D=created_at:desc"
        print(url)
        return url
